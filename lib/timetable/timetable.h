...
#define TIMETABLE_URL                         \
  "https://marudor.de/api/iris/v1/abfahrten/" \
  "TIMETABLE_STATION_ID?lookahead=60&lookbehind=0"

#define TIMETABLE_CERTIFICATE                                          \
  "-----BEGIN CERTIFICATE-----\n"                                      \
...
#define TIMETABLE_LINES 3

#define TIMETABLE_STRING_SIZE 10
...
class Timetable {
 ...
 private:
  StaticJsonBuffer<70000> json_buffer;
